...
- Correção do fluxo de aprovação/retorno da Distribuição usando `v5_4_2_mover_distribuicao`, com proteção contra duplo clique e tratamento explícito do erro legado de `motivo` ambíguo.
- Navegação consolidada em **Serviços → Escalas**, usando `pessoal.html` / `pessoal_v7.js` como implementação única.
- Removidos da navegação os acessos legados **Pessoal / Serviços**, **Pessoal / Escalas** e **Missão**.
- Mantidas as modalidades **Motorista**, **Patrulheiro** e **Permanência**.
