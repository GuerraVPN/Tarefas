...
const required=['index.html','central.html','usuarios.html','mobile-bootstrap.js','mobile-preload.js','mobile-v12.js','mobile-updates-v181.js','mobile-ai-v230.js','mobile-ai-tools-v237.js','mobile-chat-files-v233.js','mobile-chat-fix-v234.js','mobile-chat-fit-v235.js','mobile-chat-fit-v236.js'];
...
'mobile-ai-tools-v237.js':['__TAREFAS_ANDROID_237_AI_TOOLS__','📋 Copiar','📄 Arquivo','application/vnd.openxmlformats-officedocument.wordprocessingml.document','application/vnd.oasis.opendocument.text','docxBlob','odtBlob','pdfBlob','saveBase64ToDownloads'],
...
console.log(`VERIFY 2.3.7 build 237 BETA / WEB BASE 7.8.2: ${total} bytes.`);if(errors.length){for(const e of errors)console.error('ERRO: '+e);process.exit(1)}console.log('OK: respostas da IA podem ser copiadas e exportadas em PDF, DOCX, ODT, TXT, MD, CSV, JSON e HTML.');
