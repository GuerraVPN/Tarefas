...
for(const name of await readdir(dist)){
  ...
  source=source.replaceAll('2.4.3-b278','2.4.6-b281');
  source=source.replaceAll('2.4.2-b277','2.4.6-b281');
  source=source.replaceAll('2.4.0-b274','2.4.6-b281');
...
await patch('mobile-patch-manager-v240.js',source=>source
  ...
  .replaceAll("source:'beta-2.4.3'","source:'beta-2.4.6'"),{required:true});
...
await patch('mobile-bootstrap.js',source=>{
  let out=source
    ...
    .replaceAll('__TAREFAS_BETA_243_BOOT__','__TAREFAS_BETA_246_BOOT__')
    .replaceAll('__TAREFAS_PATCH_SYSTEM_V278__','__TAREFAS_PATCH_SYSTEM_V281__')
  ...
  out=out.replaceAll('tmScales243','tmScales246').replaceAll('tm243-scales-list','tm246-scales-list').replace("basedOn:'2.4.2'","basedOn:'2.4.5'");
...
await patch('mobile-alpha-v23223-fix.js',source=>source
  .replace("const VERSION='2.4.3',BUILD=278,MARK='__TAREFAS_BETA_NAV_V278__';","const VERSION='"+VERSION+"',BUILD="+BUILD+",MARK='__TAREFAS_BETA_NAV_V281__';")
  .replaceAll('TAREFAS 2.4.3 Beta','TAREFAS '+VERSION+' Beta')
  .replaceAll('TarefasBeta243','TarefasBeta246'),{required:false});
...
await patch('mobile-alpha-v23221.js',source=>source
  ...
  .replaceAll('BETA 243','BETA 246'),{required:false});

await patch('mobile-alpha-v23221-tabs.js',source=>source
  .replace("const MARK='__TAREFAS_BETA_TABS_V278__',VERSION='2.4.3',BUILD=278","const MARK='__TAREFAS_BETA_TABS_V281__',VERSION='2.4.6',BUILD=281")
...
await patch('mobile-release-v240.js',source=>{
  let out=source
    ...
    .replaceAll('__TAREFAS_BETA_243__','__TAREFAS_BETA_246__');
