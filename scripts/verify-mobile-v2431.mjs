...
must(bootstrap.includes('__TAREFAS_ALPHA_243_BOOT__'),'marker bootstrap ausente');
...
must(release.includes('__TAREFAS_ALPHA_243__'),'runtime Alpha 2.4.3.1 ausente');
...
must(manifest.version==='2.4.3.1'&&manifest.build===279&&manifest.channel==='beta','manifesto inválido');
