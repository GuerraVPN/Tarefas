...
const VERSION='2.4.3',BUILD=278,WEB_VERSION='7.9.1';
...
for(const name of await readdir(dist)){
  ...
  source=source.replaceAll('2.4.0-b274','2.4.3-b278').replaceAll('2.4.2-b277','2.4.3-b278');
...
await patch('mobile-patch-manager-v240.js',source=>source
  ...
  .replace("__TAREFAS_PATCH_MANAGER_V277__","__TAREFAS_PATCH_MANAGER_V278__")
...
await patch('mobile-bootstrap.js',source=>{
  let out=source
    ...
    .replaceAll('__TAREFAS_BETA_242_BOOT__','__TAREFAS_BETA_243_BOOT__')
  ...
  out+="\n;globalThis.__TAREFAS_BETA_243_BOOT__={version:'"+VERSION+"',build:"+BUILD+",channel:'beta',basedOn:'2.4.2',webVersion:'"+WEB_VERSION+"',launcherIconBridge:true,patchChannelsFollowApkPreferences:true,drawerScalesOnly:true};\n";
  return out;
});

await patch('mobile-alpha-v23223-fix.js',source=>source
  .replace("const VERSION='2.4.2',BUILD=277,MARK='__TAREFAS_BETA_NAV_V277__';","const VERSION='"+VERSION+"',BUILD="+BUILD+",MARK='__TAREFAS_BETA_NAV_V278__';")
...
await patch('mobile-release-v240.js',source=>{
  ...
  out=out.replaceAll('__TAREFAS_BETA_242__','__TAREFAS_BETA_243__');
  out=out.replaceAll("version:'2.4.0',build:274","version:'"+VERSION+"',build:"+BUILD);
  out+="\n;globalThis.__TAREFAS_BETA_243__=Object.freeze({version:'"+VERSION+"',build:"+BUILD+",channel:'beta',webVersion:'"+WEB_VERSION+"',launcherIconBridge:true,profileHomeIcon:true,patchChannelsFollowApkPreferences:true,drawerScalesOnly:true});\n";
