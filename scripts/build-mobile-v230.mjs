...
// Cliente do Assistente IA. A validação específica da versão final acontece no build posterior.
...
for(const marker of ['tarefasPushSession17','/functions/v1/tarefas-ai','rate_limited'])if(!ai.includes(marker))throw new Error(`mobile-ai-v230.js: marcador base ausente: ${marker}`);
...
console.log(`TAREFAS Android 2.3.0 build 230 base: Assistente IA em ${htmlFiles.length} telas, Base Web 7.8.0.`);
