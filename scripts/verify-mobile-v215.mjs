...
const required=['index.html','dashboard.html','about.html','configuracoes.html','configuracoes_senha_v215.js','orcamentarios.html','pessoal.html','pessoal_v7.js','lavanderia_v211.js','lavanderia_financeiro_v212.js','lavanderia_layout_v212.js','lavanderia_documento_v762.js','games.html','games.css','games.js','mobile-bootstrap.js','mobile-preload.js','mobile-v12.js','mobile-updates-v181.js','native-mobile.js','mobile-v196.js','ferias_dispensas_v721.js','aditamento_v74.js','v7_5_1_version.js','v7_5_1_about.js'];
...
const checks={
 ...
 'configuracoes.html':['configuracoes_senha_v215.js?v=2.1.5'],
 'configuracoes_senha_v215.js':['Alterar minha senha','Senha atual incorreta','A nova senha precisa ter pelo menos 6 caracteres',"from('usuarios').update({senha:newPass})",'v1_7_emitir_sessao_push'],
...
console.log(`VERIFY 2.1.5 build 215 BETA / WEB 7.6.4: ${root}`);console.log(`Tamanho raiz: ${total} bytes`);if(errors.length){for(const e of errors)console.error('ERRO:',e);process.exit(1)}console.log('OK: 2.1.5 beta validada com ODT/PDF, férias protegidas até ADP e alteração de senha nas Configurações.');
