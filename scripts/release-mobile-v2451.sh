...
# Recria a cadeia até a base validada 2.4.3 e aplica a camada Beta 2.4.5.
git fetch origin beta-2.3.25
BASE_DIR="$RUNNER_TEMP/base-2325-v245"
...
sed -i 's/versionCode 1/versionCode 281/' android/app/build.gradle
sed -i 's/versionName "1.0"/versionName "2.4.5.1"/' android/app/build.gradle
...
unzip -p "$UNSIGNED" assets/public/mobile-launcher-icon-v241.js > "$RUNNER_TEMP/launcher-v2451.js"
unzip -p "$UNSIGNED" assets/public/mobile-bootstrap.js > "$RUNNER_TEMP/bootstrap-v2451.js"
unzip -p "$UNSIGNED" assets/public/mobile-patch-manager-v240.js > "$RUNNER_TEMP/pm-v2451.js"
unzip -p "$UNSIGNED" assets/public/mobile-updates-v181.js > "$RUNNER_TEMP/updates-v2451.js"
unzip -p "$UNSIGNED" assets/public/mobile-dashboard-v184.js > "$RUNNER_TEMP/dashboard-v2451.js"
grep -q '__TAREFAS_LAUNCHER_ICON_241__' "$RUNNER_TEMP/launcher-v2451.js"
grep -q 'pinProfileShortcut' "$RUNNER_TEMP/launcher-v2451.js"
grep -q '__TAREFAS_ALPHA_2451_BOOT__' "$RUNNER_TEMP/bootstrap-v2451.js"
grep -q '__TAREFAS_PATCH_MANAGER_V281__' "$RUNNER_TEMP/pm-v2451.js"
grep -q "const APP_CHANNEL = 'alpha';" "$RUNNER_TEMP/updates-v2451.js"
grep -q "const APP_VERSION = '2.4.5.1';" "$RUNNER_TEMP/bootstrap-v2451.js"
grep -q "const APP_BUILD = 281;" "$RUNNER_TEMP/bootstrap-v2451.js"
grep -q "basedOn:'2.4.5'" "$RUNNER_TEMP/bootstrap-v2451.js"
grep -q "const APP_VERSION='2.4.5.1',APP_BUILD=281,APP_CHANNEL='alpha';" "$RUNNER_TEMP/pm-v2451.js"
grep -q "sha256Bytes" "$RUNNER_TEMP/pm-v2451.js"
grep -q "fetchOfficialBytes" "$RUNNER_TEMP/pm-v2451.js"
grep -q "crypto.subtle.digest" "$RUNNER_TEMP/pm-v2451.js"
grep -q "const APP_VERSION = '2.4.5.1';" "$RUNNER_TEMP/updates-v2451.js"
grep -q "const APP_BUILD = 281;" "$RUNNER_TEMP/updates-v2451.js"
grep -q '__TAREFAS_NEXT_SERVICE_REMOVED_V281__' "$RUNNER_TEMP/dashboard-v2451.js"
grep -q 'function ensureCard(){return null;}' "$RUNNER_TEMP/dashboard-v2451.js"
grep -q "tmScales245" "$RUNNER_TEMP/bootstrap-v2451.js"
grep -q "1T_BM9KY0NLwVhlifetQ6W6AdetujQjx--zOZHa27eQs" "$RUNNER_TEMP/bootstrap-v2451.js"
grep -q "1_LlfIHx4EuSHkC9BOR2VorvXoaiMyLa028wU6C0dQLs" "$RUNNER_TEMP/bootstrap-v2451.js"
grep -q "13eEei_JdGjAdVo371BGfPS59QdYySe9lJ47DLjWb_x0" "$RUNNER_TEMP/bootstrap-v2451.js"
! grep -q "Pessoal / Escalas" "$RUNNER_TEMP/bootstrap-v2451.js"
! grep -q "Missões" "$RUNNER_TEMP/bootstrap-v2451.js"
...
jq -n \
  ...
  --arg title 'TAREFAS 2.4.5.1 Alpha — Base 2.4.5' \
  --arg url "$URL" \
  --arg sha "$SHA" \
  '{
    version:$version,
