...
await patch('mobile-bootstrap.js',source=>{
  ...
  out=out.replaceAll('tmScales245','tmScales246').replaceAll('tm245-scales-list','tm246-scales-list').replace("basedOn:'2.4.3'","basedOn:'2.4.6+2.4.6.7+2.4.6.8'");
  out=out.replace("__TAREFAS_BETA_246_BOOT__={version:'"+VERSION+"',build:"+BUILD+",channel:'beta',basedOn:'2.4.6+2.4.6.7+2.4.6.8'", "__TAREFAS_BETA_246_BOOT__={version:'"+VERSION+"',build:"+BUILD+",channel:'beta',basedOn:'2.4.6+2.4.6.7+2.4.6.8'");
  return out;
},{required:true});
...
await patch('mobile-release-v240.js',source=>{
  ...
  out+="\n;globalThis.__TAREFAS_BETA_246__=Object.freeze({version:'"+VERSION+"',build:"+BUILD+",channel:'beta',basedOn:'2.4.6+2.4.6.7+2.4.6.8',webVersion:'"+WEB_VERSION+"',launcherIconBridge:true,profileHomeIcon:true,patchChannelsFollowApkPreferences:true,drawerScalesOnly:true,officialPatchSha256Bytes:true});\n";
