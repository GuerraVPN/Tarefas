...
for (const file of ['manifest.webmanifest','service-worker.js','mobile-bootstrap.js','mobile-preload.js','mobile-login-v17.js','mobile.css','mobile-v12.css','mobile-v16.css','mobile-v18.css','mobile-v181.css','mobile-v12.js','mobile-updates-v181.js','mobile-dashboard-v184.js','mobile-users-inline-v188.js']) {
...
await patch('mobile-bootstrap.js',[["const APP_VERSION = '1.8.0';","const APP_VERSION = '1.8.8';"],['const APP_BUILD = 180;','const APP_BUILD = 188;']]);
await patch('mobile-preload.js',[["tarefasAppVersion = '1.8.0'","tarefasAppVersion = '1.8.8'"],["tarefasAppBuild = '180'","tarefasAppBuild = '188'"]]);
await patch('mobile-v12.js',[['1.8.0 • WEB 7.5.2','1.8.8 • WEB 7.5.5']]);
// O patch antigo movia o bloco inteiro de propriedades + mensagens. No APK 1.8.8,
// desativamos esse comportamento legado e usamos o painel inline específico por ação.
...
for(const name of htmlFiles){
 ...
 for(const js of ['mobile-bootstrap.js','mobile-v12.js','native-mobile.js','mobile-updates-v181.js','mobile-dashboard-v184.js','mobile-users-inline-v188.js'])if(!html.includes(js))html=html.replace(/<\/body>/i,`  <script src="${js}"></script>\n</body>`);
 await writeFile(file,html,'utf8');
}
console.log(`TAREFAS Android 1.8.8 build 188 BETA: ${htmlFiles.length} páginas preparadas sobre Web 7.5.5 com propriedades e mensagens inline por usuário`);
