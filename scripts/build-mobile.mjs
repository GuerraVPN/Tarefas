...
await patch('mobile-bootstrap.js',[["const APP_VERSION = '1.8.0';","const APP_VERSION = '1.9.1';"],['const APP_BUILD = 180;','const APP_BUILD = 191;']]);
await patch('mobile-preload.js',[["tarefasAppVersion = '1.8.0'","tarefasAppVersion = '1.9.1'"],["tarefasAppBuild = '180'","tarefasAppBuild = '191'"]]);
await patch('mobile-v12.js',[['1.8.0 • WEB 7.5.2','1.9.1 • WEB 7.5.5']]);
await patch('mobile-updates-v181.js',[["const APP_VERSION = '1.8.9';","const APP_VERSION = '1.9.1';"],["const APP_BUILD = 189;","const APP_BUILD = 191;"]]);
...
await patch('native-mobile.js',[["1.8.8","1.9.1"]]);
...
console.log(`TAREFAS Android 1.9.1 build 191 BETA: ${htmlFiles.length} páginas preparadas sobre Web 7.5.5 com Bloco de Notas restaurado e adaptado ao mobile`);
