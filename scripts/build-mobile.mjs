...
await patch('mobile-bootstrap.js',[["const APP_VERSION = '1.8.0';","const APP_VERSION = '1.9.4';"],['const APP_BUILD = 180;','const APP_BUILD = 194;'],["const WEB_VERSION = '7.5.2';","const WEB_VERSION = '7.5.7';"]]);
await patch('mobile-preload.js',[["tarefasAppVersion = '1.8.0'","tarefasAppVersion = '1.9.4'"],["tarefasAppBuild = '180'","tarefasAppBuild = '194'"]]);
await patch('mobile-v12.js',[['1.8.0 • WEB 7.5.2','1.9.4 • WEB 7.5.7']]);
await patch('mobile-updates-v181.js',[["const APP_VERSION = '1.8.9';","const APP_VERSION = '1.9.4';"],["const APP_BUILD = 189;","const APP_BUILD = 194;"]]);
...
await patch('native-mobile.js',[["1.8.8","1.9.4"]]);
...
console.log(`TAREFAS Android 1.9.4 build 194 BETA: ${htmlFiles.length} páginas preparadas sobre Web 7.5.7 com contraste das escalas atualizado`);
