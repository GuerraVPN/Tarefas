...
console.log(`TAREFAS Android 1.8.9 build 189 BETA: ${htmlFiles.length} páginas preparadas sobre Web 7.5.5 com alternância exclusiva entre propriedades e mensagens`);
