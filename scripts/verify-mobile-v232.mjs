...
const markers={
'mobile-bootstrap.js':["const APP_VERSION = '2.3.2'",'const APP_BUILD = 232',"const WEB_VERSION = '7.8.2'"],
'mobile-preload.js':["tarefasAppVersion = '2.3.2'","tarefasAppBuild = '232'"],
'mobile-v12.js':['2.3.2 • WEB 7.8.2'],
'mobile-updates-v181.js':["const APP_VERSION = '2.3.2'",'const APP_BUILD = 232',"const APP_CHANNEL = 'beta'"],
...
'mobile-ai-v230.js':['__TAREFAS_ANDROID_232_AI__','X-Tarefas-Session','X-Tarefas-Profile','confirm_action','cancel_action','pending_action','leitura + ações + anexos','tarefas-ai-files','data-file-input','FileReader'],
'mobile-chat-files-v232.js':['__TAREFAS_ANDROID_232_CHAT_FILES__','tarefas-chat-files','X-Tarefas-Session','X-Tarefas-Profile','FormData','MAX_FILES=4'],
'usuarios.html':['mobile-chat-files-v232.js']};
...
console.log(`VERIFY 2.3.2 build 232 BETA / WEB BASE 7.8.2: ${total} bytes.`);if(errors.length){for(const e of errors)console.error('ERRO: '+e);process.exit(1)}console.log('OK: versão, canal beta, perfil ativo, ações IA, anexos privados e sintaxe validados.');
