(function(){
'use strict';
if(window.__TAREFAS_V792_VERSION__)return;
window.__TAREFAS_V792_VERSION__=true;
const VERSION='7.9.2',BADGE='● TAREFAS v'+VERSION;
let busy=false;
