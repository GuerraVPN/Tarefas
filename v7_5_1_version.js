(function(){
'use strict';
if(window.__TAREFAS_V7511_VERSION__)return;
window.__TAREFAS_V7511_VERSION__=true;
const VERSION='7.5.11',BADGE='● TAREFAS v'+VERSION;
let busy=false;
...
function addPatches(){addScript('v7_5_4_patch.js','__TAREFAS_V754_PATCH__');addScript('v7_5_5_patch.js','__TAREFAS_V755_PATCH__');addScript('v7_5_6_patch.js','__TAREFAS_V756_PATCH__');addScript('v7_5_7_patch.js','__TAREFAS_V757_PATCH__');addScript('v7_5_8_patch.js','__TAREFAS_V758_PATCH__')}
function ensureLabels(){
 ...
 const s=document.createElement('script');s.src='v7_5_2_service_labels.js?v='+VERSION;s.defer=true;document.head.appendChild(s);
}
function apply(){
 ...
 try{
  ...
  const siteTitle=document.querySelector('#v7412Modal h3');if(siteTitle&&siteTitle.textContent!=='Painel SITE · V'+VERSION)siteTitle.textContent='Painel SITE · V'+VERSION;
