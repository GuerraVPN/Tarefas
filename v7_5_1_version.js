(function(){
'use strict';
if(window.__TAREFAS_V769_VERSION__)return;
window.__TAREFAS_V769_VERSION__=true;
const VERSION='7.6.11',BADGE='● TAREFAS v'+VERSION;
let busy=false;
