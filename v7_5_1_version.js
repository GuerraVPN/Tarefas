(function(){
'use strict';
if(window.__TAREFAS_V764_VERSION__)return;
window.__TAREFAS_V764_VERSION__=true;
const VERSION='7.6.4',BADGE='● TAREFAS v'+VERSION;
let busy=false;
