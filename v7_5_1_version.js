(function(){
'use strict';
if(window.__TAREFAS_V755_VERSION__)return;
window.__TAREFAS_V755_VERSION__=true;
const VERSION='7.5.5',BADGE='● TAREFAS v'+VERSION;
let busy=false;
...
function addPatches(){addScript('v7_5_4_patch.js','__TAREFAS_V754_PATCH__');addScript('v7_5_5_patch.js','__TAREFAS_V755_PATCH__')}
