...
patch('package.json','"version": "1.9.7"','"version": "1.9.8"')
patch('package.json','TAREFAS Android 1.9.7 build 197 beta com aba Jogos, Dinossauro e placar público, mantendo a Base web 7.5.7.','TAREFAS Android 1.9.8 build 198 beta com nove jogos e placares públicos, mantendo a Base web 7.5.7.')
