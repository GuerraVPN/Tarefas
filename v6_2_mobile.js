...
(function(){
  ...
  add('v7_4_8_site_control.js?v=7.4.11','data-v748-site-control',function(){
   add('v7_4_11_core.js?v=7.4.11','data-v7411-core',function(){
    add('v7_4_7_mission_patch.js?v=7.4.11','data-v747-mission-patch',function(){
     add('v7_4_7_aditamento_patch.js?v=7.4.11','data-v747-aditamento-patch',function(){
      add('v6_5_patch.js?v=6.5','data-v65-loader',function(){
       add('v7_global.js?v=7.4.11','data-v7-loader',function(){
        add('v7_4_3_period.js?v=7.4.11','data-v743-period',function(){
         add('v7_4_3_pdf.js?v=7.4.11','data-v743-pdf',function(){
          add('v7_4_2_search_order.js?v=7.4.11','data-v742-search-order',function(){
           add('v7_4_2_transfer.js?v=7.4.11','data-v742-transfer',function(){
            add('v7_4_2_replace.js?v=7.4.11','data-v742-replace',function(){
             add('v7_4_10_about.js?v=7.4.11','data-v7410-about');
            });
           });
          });
         });
