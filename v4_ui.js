...
@media(min-width:901px){body.v3-shell{overflow:hidden!important}body.v3-shell .sidebar{position:fixed!important;left:0!important;top:0!important;bottom:0!important;width:238px!important;min-height:100vh!important;height:100vh!important;overflow-y:auto!important;z-index:3500!important;padding:16px!important}body.v3-shell .main-content,body.v3-shell .main{margin-left:238px!important;width:calc(100% - 238px)!important;height:100vh!important;overflow-y:auto!important;overflow-x:hidden!important}body.v3-shell .header,body.v3-shell .topbar{position:sticky!important;top:0!important;z-index:3300!important;min-height:62px!important;padding-left:20px!important;padding-right:18px!important;background:#fff!important}body.v3-shell .kanban-board{padding:16px 18px 24px!important;gap:14px!important}body.v3-shell .kanban-column{padding:14px!important}body.v3-shell .task-card{padding:13px!important;margin-bottom:10px!important}body.v3-shell .content,body.v3-shell .page{padding:18px 20px 28px!important;max-width:none!important}}
.v3-user-zone{display:flex;align-items:center;gap:8px;margin-left:10px;position:relative;flex-shrink:0}.v3-top-icon{width:38px;height:38px;border:1px solid #e5e7eb;border-radius:10px;background:#fff;display:grid;place-items:center;cursor:pointer;position:relative;color:#374151}.v3-top-icon:hover{background:#f9fafb}.v3-user-button{border:0;background:transparent;display:flex;align-items:center;gap:9px;cursor:pointer;padding:4px 5px;border-radius:10px}.v3-user-button:hover{background:#f3f4f6}.v3-avatar{width:38px;height:38px;border-radius:50%;background:#111827;color:#facc15;border:2px solid #eab308;display:grid;place-items:center;font-weight:800;overflow:hidden;flex-shrink:0}.v3-avatar img{width:100%;height:100%;object-fit:cover}.v3-user-text{text-align:left;line-height:1.2;max-width:180px}.v3-user-text strong{display:block;font-size:12px;color:#111827;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}.v3-user-text span{font-size:10px;color:#6b7280;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;display:block;margin-top:3px}.v3-profile-menu{position:absolute;right:0;top:48px;width:300px;background:#fff;border:1px solid #e5e7eb;border-radius:12px;box-shadow:0 16px 38px rgba(0,0,0,.16);padding:8px;display:none;z-index:99990}.v3-profile-menu.open{display:block}.v3-menu-title{font-size:10px;color:#6b7280;font-weight:800;text-transform:uppercase;padding:6px 8px}.v3-profile-option{width:100%;display:flex;align-items:center;justify-content:space-between;gap:8px;border:0;background:transparent;padding:9px 10px;border-radius:8px;text-align:left;cursor:pointer;color:#374151}.v3-profile-option:hover{background:#f3f4f6}.v3-profile-option.active{background:#ecfdf5;color:#065f46;font-weight:700}.v3-profile-option small{display:block;color:#9ca3af;margin-top:2px}.v3-menu-sep{height:1px;background:#e5e7eb;margin:6px 0}.v3-menu-action{width:100%;border:0;background:transparent;text-align:left;padding:9px 10px;border-radius:8px;cursor:pointer;color:#374151}.v3-menu-action:hover{background:#f3f4f6}.v3-menu-action.danger{color:#dc2626}.v3-count{position:absolute;right:-5px;top:-6px;min-width:18px;height:18px;padding:0 4px;border-radius:999px;background:#dc2626;color:#fff;font:700 10px/18px Arial;text-align:center;display:none}.v3-count.show{display:block}.v3-central-nav-badge{margin-left:auto;background:#dc2626;color:#fff;border-radius:999px;min-width:19px;height:19px;padding:0 5px;display:none;align-items:center;justify-content:center;font-size:10px;font-weight:800}.v3-central-nav-badge.show{display:inline-flex}.v3-password-bg{position:fixed;inset:0;background:rgba(17,24,39,.55);z-index:100000;display:none;align-items:center;justify-content:center;padding:18px}.v3-password-bg.open{display:flex}.v3-password-box{width:min(430px,100%);background:#fff;border-radius:14px;padding:20px;box-shadow:0 25px 70px rgba(0,0,0,.2)}.v3-password-box h3{margin-bottom:14px}.v3-password-box label{display:block;font-size:12px;font-weight:700;color:#4b5563;margin:10px 0 5px}.v3-password-box input{width:100%;padding:10px;border:1px solid #d1d5db;border-radius:8px}.v3-password-actions{display:flex;justify-content:flex-end;gap:9px;margin-top:17px}.v3-password-actions button{border:1px solid #d1d5db;border-radius:8px;padding:9px 13px;background:#fff;font-weight:700;cursor:pointer}.v3-password-actions .save{background:#047857;color:#fff;border-color:#047857}.task-last-update{margin-top:7px;font-size:9px;color:#9ca3af;display:flex;align-items:center;gap:4px}.v3-create-resp{margin-top:7px;border:1px solid #d1d5db;border-radius:9px;background:#fff;overflow:hidden}.v3-create-resp-head{display:flex;align-items:center;justify-content:space-between;gap:8px;padding:9px 10px;background:#f9fafb}.v3-create-resp-head span{font-size:11px;color:#6b7280}.v3-create-resp-head button{border:0;background:#047857;color:#fff;border-radius:7px;padding:7px 10px;font-weight:700;cursor:pointer}.v3-create-selected{display:flex;flex-wrap:wrap;gap:5px;padding:8px 10px;min-height:38px}.v3-create-chip{font-size:10px;background:#ecfdf5;color:#065f46;border:1px solid #a7f3d0;border-radius:999px;padding:4px 7px}.v3-create-empty{font-size:11px;color:#9ca3af}.v3-create-panel{display:none;border-top:1px solid #e5e7eb;padding:9px}.v3-create-panel.open{display:block}.v3-create-panel input[type=search]{width:100%;padding:8px;border:1px solid #d1d5db;border-radius:7px;margin-bottom:7px}.v3-create-list{max-height:210px;overflow:auto;display:grid;gap:4px}.v3-create-row{display:flex;align-items:flex-start;gap:8px;padding:7px;border-radius:7px;cursor:pointer}.v3-create-row:hover{background:#f3f4f6}.v3-create-row strong{font-size:11px;display:block}.v3-create-row small{font-size:9px;color:#6b7280}@media(max-width:900px){.v3-user-text{display:none}.v3-user-zone{gap:5px}.v3-profile-menu{position:fixed;right:10px;top:66px;max-width:calc(100vw - 20px)}}`;document.head.appendChild(s);document.body.classList.add('v3-shell')}
