...
function addNav(){const list=document.querySelector('.sidebar ul');if(!list)return;const cfg=()=>[...list.children].find(x=>(x.textContent||'').toLowerCase().includes('config'));if(!list.querySelector('[data-v3-central]')){const li=document.createElement('li');li.dataset.v3Central='1';li.innerHTML='🔔 Central <span class="v3-central-nav-badge" id="v3NavCount">0</span>';li.onclick=()=>location.href='central.html';const c=cfg();if(c)list.insertBefore(li,c);else list.appendChild(li)}if(!list.querySelector('[data-v5-orcamentarios]')){const li=document.createElement('li');li.dataset.v5Orcamentarios='1';li.innerHTML='📑 Orçamentários';li.onclick=()=>location.href='orcamentarios.html';const c=cfg();if(c)list.insertBefore(li,c);else list.appendChild(li)}}
