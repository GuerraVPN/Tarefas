...
let baseUser=null,user=null,isAdmin=false;
...
function switchModule(mode){
 ...
 const pedidos=mode==='baixas'||mode==='distribuicao';
 $('guiasModule').hidden=!guides;
 $('pedidosModule').hidden=!pedidos;
...
async function start(){
 ...
 const params=new URLSearchParams(location.search);
 if(params.get('modulo')==='movimentacao')return;
