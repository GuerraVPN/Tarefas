...
const PATCH_VERSION='2.4.0';
const BASE_VERSION='2.4.0';
const BUILD=274;
...
function installErrorStoreSanitizer(){
  ...
  window.dispatchEvent(new CustomEvent('tarefas:alpha-state',{detail:{source:'patch-2.4.0'}}));
}
...
function installAdvancedTaskFilters(){
  ...
  // A 2.4.0.4 captura inputs/selects com ID, então este novo status
...
function normalizeSavedFilterScopes(){
  ...
  if(changed){s.updatedAt=Date.now();localStorage.setItem(k,JSON.stringify(s));window.dispatchEvent(new CustomEvent('tarefas:alpha-state',{detail:{source:'patch-2.4.0-filter-scope'}}))}
  return changed;
}
...
;globalThis.__TAREFAS_RELEASE_240_CONSOLIDATED__=Object.freeze({version:'2.4.0',build:274,channel:'official',consolidates:['2.3.24.1','2.3.24.2','2.3.24.3','2.3.24.4','2.3.24.5','2.3.24.6','2.3.24.7','2.3.24.8','2.3.24.9'],alphaAutoPatchCheck:true});

/* Consolidated 2.3.25.1–2.3.25.3 */
(()=>{
'use strict';
...
const MARK='__TAREFAS_RELEASE_240_WEB_791_SAFE__';
...
globalThis.TarefasWebBase240=Object.freeze({
...
const MARK='__TAREFAS_RELEASE_240_DIAGNOSTIC_TABS__';
if(globalThis[MARK])return;
globalThis[MARK]=true;
...
globalThis.TarefasDiagnosticTabs240=Object.freeze({
  version:PATCH_VERSION,
...
;globalThis.__TAREFAS_RELEASE_240__=Object.freeze({version:'2.4.0',build:274,channel:'official',webVersion:'7.9.1',consolidates:['2.3.24.1','2.3.24.2','2.3.24.3','2.3.24.4','2.3.24.5','2.3.24.6','2.3.24.7','2.3.24.8','2.3.24.9','2.3.25.1','2.3.25.2','2.3.25.3'],coldStartBiometric:true,diagnosticTabs:true,patchManager:true});
