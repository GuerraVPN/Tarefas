...
const sha256=async value=>sha256Bytes(new TextEncoder().encode(String(value)));
...
async function installOfficial(meta){
  ...
  if(String(meta.sha256||'').toLowerCase()!==actual)throw new Error('SHA-256 dos bytes do arquivo oficial não confere.');
