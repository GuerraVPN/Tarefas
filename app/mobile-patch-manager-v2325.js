...
const APP_VERSION='2.3.25',APP_BUILD=272,APP_CHANNEL='beta';
...
const MARK='__TAREFAS_PATCH_MANAGER_V272__';
...
;(()=>{
'use strict';
const MARK='__TAREFAS_ALPHA_AUTO_PATCH_CHECK_V272__';
if(globalThis[MARK])return;globalThis[MARK]=true;
...
globalThis.TarefasAlphaAutoPatchCheckV272=Object.freeze({
  version:'2.3.25',build:272,intervalMs:INTERVAL,run:autoCheckOfficialPatches
});
})();
